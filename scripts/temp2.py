...
if __name__ == '__main__':
	...
	while not rospy.is_shutdown():
		while i!=10:
			swift_drone.setpoint = swift_drone.setpoints[i]
			while True:
				swift_drone.pid()
				if(swift_drone.drone_position[0] < swift_drone.setpoint[i][0]+0.2 and swift_drone.drone_position[0] > swift_drone.setpoint[i][0]-0.2 and swift_drone.drone_position[1] < swift_drone.setpoint[i][1]+0.2 and swift_drone.drone_position[1] > swift_drone.setpoint[i][1]-0.2 and swift_drone.drone_position[2] < swift_drone.setpoint[i][2]+0.2 and swift_drone.drone_position[2] > swift_drone.setpoint[i][2] - 0.2):
